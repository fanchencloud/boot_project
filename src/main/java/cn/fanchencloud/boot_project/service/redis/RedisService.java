package cn.fanchencloud.boot_project.service.redis;
...
public class RedisService {
     ...
     */
    public boolean expireTime(final String key, final long timeout) {
     ...
     */
    public boolean hasHashKey(final String key, String hashKey) {
